...
"<form action='/wifi'    method='get'><button>Skanna efter nätverk</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>Manuell WiFi</button></form><br/>\n", // MENU_WIFINOSCAN
"<form action='/info'    method='get'><button>Info</button></form><br/>\n", // MENU_INFO
"<form action='/param'   method='get'><button>Setup</button></form><br/>\n",//MENU_PARAM
"<form action='/close'   method='get'><button>Stäng</button></form><br/>\n", // MENU_CLOSE
...
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='s'>SSID</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><br/><label for='p'>Lösenord</label><input id='p' name='p' maxlength='64' type='password' placeholder=''>"; //Password
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Sparar inställningar.<br/>Försöker ansluta enheten till nätverket.<br />Om det misslyckas, återanslut till enheten för att försöka igen.</div>"; //Saving Credentials Trying to connect ESP to network. If it fails reconnect to AP to try again
const char HTTP_PARAMSAVED[]       PROGMEM = "<div class='msg'>Sparad<br/></div>"; //Saved
const char HTTP_END[]              PROGMEM = "</div></body></html>";
const char HTTP_ERASEBTN[]         PROGMEM = "<br/><form action='/erase' method='get'><button class='D'>Radera Sparade Nätverk</button></form>"; //Erase WiFi Config
...
const char HTTP_STATUS_OFFPW[]     PROGMEM = "<br/>Fel lösenord"; // STATION_WRONG_PASSWORD,  no eps32 //Authentication Failure
const char HTTP_STATUS_OFFNOAP[]   PROGMEM = "<br/>Nätverket hittades ej";   // WL_NO_SSID_AVAIL //AP not found
const char HTTP_STATUS_OFFFAIL[]   PROGMEM = "<br/>Kunde inte ansluta"; // WL_CONNECT_FAILED //Could not Connect
const char HTTP_STATUS_NONE[]      PROGMEM = "<div class='msg'>Inget nätverk sparat</div>"; //No AP set
...
const char S_NA[]                 PROGMEM = "Okänd"; //Unknown

const char S_titlewifisaved[]     PROGMEM = "Credentials Saved"; //Credentials Saved
const char S_titlewifi[]          PROGMEM = "Ställ in WiFi"; //Config ESP
const char S_titleinfo[]          PROGMEM = "Info"; //Info
const char S_titleparam[]         PROGMEM = "Inställningar"; //Setup
const char S_titleparamsaved[]    PROGMEM = "Inställningar Sparade"; //Setup Saved
const char S_titleexit[]          PROGMEM = "Avsluta"; //Exit
const char S_titlereset[]         PROGMEM = "Återställ"; //Reset
const char S_titleerase[]         PROGMEM = "Radera"; //Erase
const char S_titleclose[]         PROGMEM = "Stäng"; //Close
const char S_options[]            PROGMEM = "Alternativ"; //Options
const char S_nonetworks[]         PROGMEM = "Inga nätvärk hittades. Skanna för att försöka igen."; //No networks found. Refresh to scan again.
const char S_staticip[]           PROGMEM = "Static IP";
const char S_staticgw[]           PROGMEM = "Static Gateway";
const char S_staticdns[]          PROGMEM = "Static DNS";
const char S_subnet[]             PROGMEM = "Subnet";
const char S_exiting[]            PROGMEM = "Avslutar"; //Exiting
const char S_resetting[]          PROGMEM = "Enheten kommer att återställas om ett par sekunder."; //Module will reset in a few seconds.
const char S_closing[]            PROGMEM = "Du kan stänga fönstret, portalen kommer att fortsätta köra"; //You can close the page, portal will continue to run
